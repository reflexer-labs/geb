...
A reflex-bond is a low volatility proxy for the underlying collateral that supports its value. The _future_ price for a reflex-bond depends on the market price deviation from its _current_ price.
