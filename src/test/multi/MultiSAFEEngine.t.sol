...
import {EnglishCollateralAuctionHouse} from './MultiCollateralAuctionHouse.t.sol';
import {DebtAuctionHouse} from './MultiDebtAuctionHouse.t.sol';
...
contract TestMultiAccountingEngine is MultiAccountingEngine {
    constructor(address safeEngine, address surplusAuctionHouse, address debtAuctionHouse)
        public MultiAccountingEngine(safeEngine, surplusAuctionHouse, debtAuctionHouse) {}
...
contract SingleModifySAFECollateralizationTest is DSTest {
    ...
    function setUp() public {
        ...
        taxCollector = new MultiTaxCollector(address(safeEngine));
...
/* contract SingleLiquidationTest is DSTest {
    ...
    function setUp() public {
        ...
        accountingEngine = new TestMultiAccountingEngine(
