...
contract IncreasingDiscountCollateralAuctionHouseMock {
    // --- Auth ---
    ...
    **/
    ...
    function addUint48(uint48 x, uint48 y) internal pure returns (uint48 z) {
        assert((z = x + y) >= x); //, "IncreasingDiscountCollateralAuctionHouse/add-uint48-overflow");
    }
    function addUint256(uint256 x, uint256 y) internal pure returns (uint256 z) {
        assert((z = x + y) >= x); //, "IncreasingDiscountCollateralAuctionHouse/add-uint256-overflow");
    }
    function subtract(uint256 x, uint256 y) internal pure returns (uint256 z) {
        assert((z = x - y) <= x); // "IncreasingDiscountCollateralAuctionHouse/sub-underflow");
    }
    function multiply(uint256 x, uint256 y) internal pure returns (uint256 z) {
        assert(y == 0 || (z = x * y) / y == x); //, "IncreasingDiscountCollateralAuctionHouse/mul-overflow");
    }
    ...
    function rmultiply(uint256 x, uint256 y) internal pure returns (uint256 z) {
        z = x * y;
        assert(y == 0 || z / y == x); //, "IncreasingDiscountCollateralAuctionHouse/rmul-overflow");
        z = z / RAY;
    }
     ...
     */
    function modifyParameters(bytes32 parameter, address data) internal isAuthorized {
    ...
    */
     ...
     * @param id ID of the auction to settle
     */
    function terminateAuctionPrematurely(uint256 id) internal isAuthorized {
        require(both(bids[id].amountToSell > 0, bids[id].amountToRaise > 0), "IncreasingDiscountCollateralAuctionHouse/inexistent-auction");
