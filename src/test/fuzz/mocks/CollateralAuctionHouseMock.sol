...
contract FixedDiscountCollateralAuctionHouseMock {
    // --- Auth ---
    ...
    **/
    ...
    function addUint48(uint48 x, uint48 y) internal pure returns (uint48 z) {
        assert((z = x + y) >= x); //, "FixedDiscountCollateralAuctionHouse/add-uint48-overflow");
    }
    function addUint256(uint256 x, uint256 y) internal pure returns (uint256 z) {
        assert((z = x + y) >= x); //, "FixedDiscountCollateralAuctionHouse/add-uint256-overflow");
    }
    function subtract(uint256 x, uint256 y) internal pure returns (uint256 z) {
        assert((z = x - y) <= x); //, "FixedDiscountCollateralAuctionHouse/sub-underflow");
    }
    function multiply(uint256 x, uint256 y) internal pure returns (uint256 z) {
        assert(y == 0 || (z = x * y) / y == x); //, "FixedDiscountCollateralAuctionHouse/mul-overflow");
    }
