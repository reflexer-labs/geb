...
//
//         surplusAuctionHouseTwo = new SAH_TWO(address(cdpEngine));
...
//     }
//     function try_increaseBidSize(uint id, uint amountToBuy, uint bid) internal returns (bool ok) {
...
//         }
//     }
//     function can_auction_surplus_two() public returns (bool) {
...
//         SAH_TWO newSurplusAuctionHouse = new SAH_TWO(address(cdpEngine));
...
//
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(surplusAuctionHouseTwo)), 1);
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(newSurplusAuctionHouse)), 0);
//
...
//
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(surplusAuctionHouseTwo)), 0);
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(newSurplusAuctionHouse)), 1);
//     }
//
...
//         assertEq(surplusAuctionHouseTwo.live(), 1);
//         assertEq(debtAuctionHouse.live(), 1);
//         accountingEngine.disableContract();
//         assertEq(surplusAuctionHouseTwo.live(), 0);
//         assertEq(debtAuctionHouse.live(), 0);
//     }
//
//     function test_disable_prefunded_surplusAuctionHouse() public {
...
//         assertTrue( can_auction_surplus_two() );
//     }
//
...
//         popDebtFromQueue(100 ether);
//         uint id = accountingEngine.debtAuctionHouse();
//
//         cdpEngine.mint(address(this), 100 ether);
//         debtAuctionHouse.increaseBidSize(id, 0 ether, rad(100 ether));
//
//         assertTrue(!can_auction_surplus_two() );
//     }
//
...
//         cdpEngine.mint(address(this), 100 ether);
//
//         debtAuctionHouse.increaseBidSize(id, 0 ether, rad(100 ether));  // debt auction succeeds..
//
//         assertTrue(!can_auction_surplus_two() );
//     }
//
...
//
//         cdpEngine.mint(address(this), 100 ether);
//         assertTrue(try_increaseBidSize(id, 2 ether,  rad(100 ether)));
//
//         cdpEngine.mint(address(this), 100 ether);
//         assertTrue(try_increaseBidSize(id, 1 ether,  rad(100 ether)));
//     }
// }
//
// contract Gem {
...
//         }
//     }
//     function can_surplusAuctionHouseOne() public returns (bool) {
//         string memory sig = "surplusAuctionHouse()";
//         bytes memory data = abi.encodeWithSignature(sig);
//
//         bytes memory can_call = abi.encodeWithSignature("try_call(address,bytes)", accountingEngine, data);
//         (bool ok, bytes memory success) = address(this).call(can_call);
...
//     }
//     function popDebtFromQueue(uint wad) internal {
//         createUnbackedDebt(address(0), wad);  // createUnbackedDebt dai into the zero address
//         accountingEngine.popDebtFromQueue(now);
//     }
//     function settleDebt(uint wad) internal {
//         accountingEngine.settleDebt(rad(wad));
...
//         newDAH.addAuthorization(address(accountingEngine));
//
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(surplusAuctionHouseOne)), 1);
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(newSAH_ONE)), 0);
//
...
//         assertEq(address(accountingEngine.debtAuctionHouse()), address(newDAH));
//
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(surplusAuctionHouseOne)), 0);
//         assertEq(cdpEngine.canModifyCDP(address(accountingEngine), address(newSAH_ONE)), 1);
//     }
//
//     function test_popDebtFromQueue_delay() public {
//         assertEq(accountingEngine.popDebtDelay(), 0);
...
//         cdpEngine.mint(address(accountingEngine), 100 ether);
//         assertTrue( can_surplusAuctionHouseOne() );
//     }
//
//     function test_no_surplus_auction_pending_debt() public {
//         accountingEngine.modifyParameters("surplusAuctionAmountSold", uint256(0 ether));
