...
contract OptimismCoin {
     ...
     */
    function addAuthorization(address account) external isAuthorized {
        require(msg.sender != l2Bridge, "Coin/bridge-cannot-deauth");
    ...
    function removeAuthorization(address account) external isAuthorized {
        require(msg.sender != l2Bridge, "Coin/bridge-cannot-deauth");
        require(account != l2Bridge, "Coin/cannot-remove-bridge");
    ...
    **/
    ...
    // The symbol of this coin
    string  public symbol;
    // The version of this Coin contract for L2 Optimism
    ...
    constructor(
        ...
        require(l1Token_ != address(0), "Coin/null-l1-token");
        require(l2Bridge_ != address(0), "Coin/null-l2-bridge");

        authorizedAccounts[msg.sender] = 1;
        authorizedAccounts[l2Bridge_]  = 1;
        ...
        emit AddAuthorization(msg.sender);
        emit AddAuthorization(l2Bridge);
    }
