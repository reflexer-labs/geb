/// MultiIncreasingDiscountCollateralAuctionHouse.sol
...
contract MultiIncreasingDiscountCollateralAuctionHouse {
    // --- Auth ---
    ...
    **/
    modifier isAuthorized {
        require(authorizedAccounts[msg.sender] == 1, "MultiIncreasingDiscountCollateralAuctionHouse/account-not-authorized");
        _;
    }
    ...
    function addUint48(uint48 x, uint48 y) internal pure returns (uint48 z) {
        require((z = x + y) >= x, "MultiIncreasingDiscountCollateralAuctionHouse/add-uint48-overflow");
    }
    function addUint256(uint256 x, uint256 y) internal pure returns (uint256 z) {
        require((z = x + y) >= x, "MultiIncreasingDiscountCollateralAuctionHouse/add-uint256-overflow");
    }
    function subtract(uint256 x, uint256 y) internal pure returns (uint256 z) {
        require((z = x - y) <= x, "MultiIncreasingDiscountCollateralAuctionHouse/sub-underflow");
    }
    function multiply(uint256 x, uint256 y) internal pure returns (uint256 z) {
        require(y == 0 || (z = x * y) / y == x, "MultiIncreasingDiscountCollateralAuctionHouse/mul-overflow");
    }
    ...
    function rdivide(uint256 x, uint256 y) internal pure returns (uint256 z) {
        require(y > 0, "MultiIncreasingDiscountCollateralAuctionHouse/rdiv-by-zero");
        z = multiply(x, RAY) / y;
    }
    function rmultiply(uint256 x, uint256 y) internal pure returns (uint256 z) {
        z = x * y;
        require(y == 0 || z / y == x, "MultiIncreasingDiscountCollateralAuctionHouse/rmul-overflow");
        z = z / RAY;
    }
    function wdivide(uint256 x, uint256 y) internal pure returns (uint256 z) {
        require(y > 0, "MultiIncreasingDiscountCollateralAuctionHouse/wdiv-by-zero");
        z = multiply(x, WAD) / y;
    }
    ...
    function modifyParameters(bytes32 parameter, uint256 data) external isAuthorized {
        if (parameter == "minDiscount") {
            require(both(data >= maxDiscount, data < WAD), "MultiIncreasingDiscountCollateralAuctionHouse/invalid-min-discount");
            minDiscount = data;
        }
        else if (parameter == "maxDiscount") {
            require(both(both(data <= minDiscount, data < WAD), data > 0), "MultiIncreasingDiscountCollateralAuctionHouse/invalid-max-discount");
            maxDiscount = data;
        }
        else if (parameter == "perSecondDiscountUpdateRate") {
            require(data <= RAY, "MultiIncreasingDiscountCollateralAuctionHouse/invalid-discount-update-rate");
            perSecondDiscountUpdateRate = data;
        }
        else if (parameter == "maxDiscountUpdateRateTimeline") {
            require(both(data > 0, uint256(uint48(-1)) > addUint256(now, data)), "MultiIncreasingDiscountCollateralAuctionHouse/invalid-update-rate-time");
            maxDiscountUpdateRateTimeline = data;
        }
        else if (parameter == "lowerCollateralMedianDeviation") {
            require(data <= WAD, "MultiIncreasingDiscountCollateralAuctionHouse/invalid-lower-collateral-median-deviation");
            lowerCollateralMedianDeviation = data;
        }
        else if (parameter == "upperCollateralMedianDeviation") {
            require(data <= WAD, "MultiIncreasingDiscountCollateralAuctionHouse/invalid-upper-collateral-median-deviation");
            upperCollateralMedianDeviation = data;
        }
        else if (parameter == "lowerSystemCoinMedianDeviation") {
            require(data <= WAD, "MultiIncreasingDiscountCollateralAuctionHouse/invalid-lower-system-coin-median-deviation");
            lowerSystemCoinMedianDeviation = data;
        }
        else if (parameter == "upperSystemCoinMedianDeviation") {
            require(data <= WAD, "MultiIncreasingDiscountCollateralAuctionHouse/invalid-upper-system-coin-median-deviation");
        ...
        else revert("MultiIncreasingDiscountCollateralAuctionHouse/modify-unrecognized-param");
    ...
    */
    function getCollateralFSMAndFinalSystemCoinPrices(uint256 systemCoinRedemptionPrice) public view returns (uint256, uint256) {
        require(systemCoinRedemptionPrice > 0, "MultiIncreasingDiscountCollateralAuctionHouse/invalid-redemption-price-provided");
    ...
    */
    ...
    function startAuction(
        ...
        require(amountToRaise >= RAY, "MultiIncreasingDiscountCollateralAuctionHouse/dusty-auction");
        id = ++auctionsStarted;
    ...
    function getCollateralBought(uint256 id, uint256 wad) external returns (uint256, uint256) {
        ...
        lastReadRedemptionPrice = oracleRelayer.redemptionPrice(coinName);
    ...
    function buyCollateral(uint256 id, uint256 wad) external {
        ...
        require(both(wad > 0, wad >= minimumBid), "MultiIncreasingDiscountCollateralAuctionHouse/invalid-bid");
        ...
        (uint256 collateralFsmPriceFeedValue, uint256 systemCoinPriceFeedValue) = getCollateralFSMAndFinalSystemCoinPrices(lastReadRedemptionPrice);
        require(collateralFsmPriceFeedValue > 0, "MultiIncreasingDiscountCollateralAuctionHouse/collateral-fsm-invalid-value");
        ...
        require(
          ...
          "MultiIncreasingDiscountCollateralAuctionHouse/invalid-left-to-raise"
        );
